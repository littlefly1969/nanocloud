...
public sealed class PlateProviderParsingTests
{
    ...
    [Theory]
    [InlineData("ExistingNanoCloudFaceDetector", false, PlateFaceRedactionProvider.ExistingNanoCloudFaceDetector)]
    ...
    public void Options_ResolveProvider_Uses_Fallback()
    {
        ...
        Assert.Equal(PlateFaceRedactionProvider.ExistingNanoCloudFaceDetector,
