...
using NanoCloud.Api.Tests.Integration;
using Xunit;

namespace NanoCloud.Api.Tests.ShareLinks;
...
public sealed class ShareLinkServicePostgresTests : IAsyncLifetime, IDisposable
{
    ...
    public async Task InitializeAsync()
    {
        ...
        _storageRoot = Path.Combine(Path.GetTempPath(), $"nanocloud-pg-share-{Guid.NewGuid():N}");
