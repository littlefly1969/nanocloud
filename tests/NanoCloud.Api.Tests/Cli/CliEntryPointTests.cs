...
public sealed class CliEntryPointTests : IDisposable
{
    ...
    public async Task EnsureUser_Reads_From_Environment_Variables()
    {
        ...
        var oldEmail = Environment.GetEnvironmentVariable("NANO_CLOUD_ADMIN_EMAIL");
        var oldName = Environment.GetEnvironmentVariable("NANO_CLOUD_ADMIN_DISPLAY_NAME");
        var oldPwd = Environment.GetEnvironmentVariable("NANO_CLOUD_ADMIN_PASSWORD");
        try
        {
            Environment.SetEnvironmentVariable("NANO_CLOUD_ADMIN_EMAIL", "bob@example.com");
            Environment.SetEnvironmentVariable("NANO_CLOUD_ADMIN_DISPLAY_NAME", "Bob");
            Environment.SetEnvironmentVariable("NANO_CLOUD_ADMIN_PASSWORD", "bob-password-1");
        ...
        {
            Environment.SetEnvironmentVariable("NANO_CLOUD_ADMIN_EMAIL", oldEmail);
            Environment.SetEnvironmentVariable("NANO_CLOUD_ADMIN_DISPLAY_NAME", oldName);
            Environment.SetEnvironmentVariable("NANO_CLOUD_ADMIN_PASSWORD", oldPwd);
        }
    }
    ...
    public async Task Help_Lists_Available_Commands()
    {
        ...
        Assert.Contains("NANO_CLOUD_ADMIN_EMAIL", text);
    }
