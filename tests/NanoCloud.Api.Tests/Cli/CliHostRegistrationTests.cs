...
namespace NanoCloud.Api.Tests.Cli;
...
public sealed class CliHostRegistrationTests : IDisposable
{
    ...
    public void Worker_Host_Binds_Video_Segmentation_Options_And_Registers_Its_Handler()
    {
        ...
        var options = sp.GetRequiredService<
            IOptions<NanoCloud.Api.Ai.Video.VideoSemanticSegmentationOptions>>().Value;
    ...
    public void Cli_Host_Resolves_Every_Service_A_Cli_Verb_Dispatches_To()
    {
        ...
        Assert.NotNull(services.GetService<NanoCloud.Api.Users.IUserService>());        // users *
        Assert.NotNull(services.GetService<NanoCloud.Api.Data.AppDbContext>());          // db migrate
        Assert.NotNull(services.GetService<NanoCloud.Api.Metadata.MetadataBackfillService>());        // metadata backfill
        Assert.NotNull(services.GetService<NanoCloud.Api.Files.IFileItemService>());     // metadata recompute-effective-dates
        Assert.NotNull(services.GetService<NanoCloud.Api.Files.MediaDerivativesBackfillService>());   // media derivatives backfill
        Assert.NotNull(services.GetService<NanoCloud.Api.Files.GalleryDerivativesRegenerationService>()); // gallery derivatives regenerate
        Assert.NotNull(services.GetService<NanoCloud.Api.Files.MediaDerivativeBytesService>());       // media derivatives verify-/repair-bytes
        Assert.NotNull(services.GetService<NanoCloud.Api.Files.PosterRegenerationService>());         // media posters regenerate
        Assert.NotNull(services.GetService<NanoCloud.Api.Storage.StorageReconciliationService>());    // storage reconcile
