...
public sealed class VideoFaceTrackPersonFlagTests
{
        ...
        var handler = new AiVideosFacesBackfillJobHandler(
            ...
            new VideoFaceAnalysisBackfillService(
                ...
                new VideoFaceAnalysisService(
                    scope.ServiceProvider.GetRequiredService<AppDbContext>(),
                    scope.ServiceProvider.GetRequiredService<NanoCloud.Api.Storage.IBlobService>(),
                    extractor,
    ...
    private sealed class RecordingJobQueue : IJobQueue
    {
        ...
        public Task<NanoCloud.Api.Domain.BackgroundJob> EnqueueAsync<TPayload>(
        ...
        {
            Enqueued.Add(type);
            return Task.FromResult(new NanoCloud.Api.Domain.BackgroundJob
            {
    ...
    private sealed class NoopDiagnostics : NanoCloud.Api.Ai.Diagnostics.IAiDiagnosticsWriter
    {
