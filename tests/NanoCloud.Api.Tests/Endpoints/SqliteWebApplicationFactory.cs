...
using NanoCloud.Api.ShareLinks;
using NanoCloud.Api.Storage;
using NanoCloud.Api.Tv;
using NanoCloud.Api.Uploads;
using NanoCloud.Api.Users;

namespace NanoCloud.Api.Tests.Endpoints;
...
public sealed class SqliteWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    public SqliteWebApplicationFactory(
        ...
        bool poolHost = false)
    {
        StorageRoot = Path.Combine(Path.GetTempPath(), $"nanocloud-endpoint-{Guid.NewGuid():N}");
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices((context, services) =>
        {
            ...
            // (Postgres-only block).
            services.AddScoped<NanoCloud.Api.Albums.Sharing.IAlbumAccessResolver,
            ...
            services.AddScoped<NanoCloud.Api.Media.IMediaCollectionQueryService,
                NanoCloud.Api.Media.MediaCollectionQueryService>();
            services.AddScoped<NanoCloud.Api.Party.IPartyLinkService, NanoCloud.Api.Party.PartyLinkService>();
            services.AddScoped<NanoCloud.Api.Party.IPartyMediaService, NanoCloud.Api.Party.PartyMediaService>();
            services.AddScoped<NanoCloud.Api.Party.IPartyUploadService, NanoCloud.Api.Party.PartyUploadService>();
            services.AddScoped<NanoCloud.Api.Party.IPartyModerationService, NanoCloud.Api.Party.PartyModerationService>();
            services.AddScoped<NanoCloud.Api.Party.IPartyFaceSearchService, NanoCloud.Api.Party.PartyFaceSearchService>();
            ...
            services.AddScoped<IJobQueueAccessor, NanoCloud.Api.Jobs.VideoHlsJobQueueAccessor>();
            services.AddScoped<VideoHlsServingService>();
            services.AddScoped<NanoCloud.Api.Admin.AdminJobCatalogService>();
            ...
            // Private Vault (v0).
            services.AddScoped<NanoCloud.Api.Vault.IPrivateVaultService,
                NanoCloud.Api.Vault.PrivateVaultService>();
            ...
            services.Configure<NanoCloud.Api.Plates.PlatesAlprOptions>(
                context.Configuration.GetSection(NanoCloud.Api.Plates.PlatesAlprOptions.SectionName));
            services.Configure<NanoCloud.Api.Plates.PlatesFaceRedactionOptions>(
                context.Configuration.GetSection(NanoCloud.Api.Plates.PlatesFaceRedactionOptions.SectionName));
            ...
            services.Configure<NanoCloud.Api.Aesthetics.AestheticsOptions>(
                context.Configuration.GetSection(NanoCloud.Api.Aesthetics.AestheticsOptions.SectionName));
            services.AddScoped<NanoCloud.Api.Aesthetics.IAestheticLabService,
                NanoCloud.Api.Aesthetics.AestheticLabService>();
            services.AddScoped<NanoCloud.Api.Aesthetics.IAestheticAnalysisService,
                NanoCloud.Api.Aesthetics.AestheticAnalysisService>();
            // TV "Beauty Lab" QR mobile-upload capability service (mirror prod).
            services.AddScoped<NanoCloud.Api.Aesthetics.IAestheticUploadSessionService,
                NanoCloud.Api.Aesthetics.AestheticUploadSessionService>();
            services.AddSingleton<NanoCloud.Api.Tests.Aesthetics.FakeAestheticModelClient>();
            services.AddScoped<NanoCloud.Api.Aesthetics.Sidecar.IAestheticModelClient>(
                sp => sp.GetRequiredService<NanoCloud.Api.Tests.Aesthetics.FakeAestheticModelClient>());
            // Post-ingestion media pipeline (direct-upload → background media work).
            services.AddScoped<NanoCloud.Api.Ingestion.IPostIngestionMediaPipelineService,
                NanoCloud.Api.Ingestion.PostIngestionMediaPipelineService>();
    ...
    private static void ResetPooledHost(PooledHost pooled)
    {
        ...
        pooled.Host.Services
            .GetRequiredService<NanoCloud.Api.Tests.Aesthetics.FakeAestheticModelClient>()
            .Reset();
    }
