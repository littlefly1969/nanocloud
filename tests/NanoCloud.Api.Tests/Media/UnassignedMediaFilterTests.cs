...
using NanoCloud.Api.Media;
using NanoCloud.Api.Media.Semantic;
using NanoCloud.Api.Tests.Endpoints;
using Xunit;
using static NanoCloud.Api.Tests.Media.MediaSemanticTestHarness;

namespace NanoCloud.Api.Tests.Media;
...
public sealed class UnassignedMediaFilterTests : IDisposable
{
    ...
    public async Task A_Cursor_Issued_Without_The_Filter_Is_Rejected_With_It()
    {
        ...
        await Assert.ThrowsAsync<NanoCloud.Api.Ai.Photos.SemanticSearchCursorException>(
