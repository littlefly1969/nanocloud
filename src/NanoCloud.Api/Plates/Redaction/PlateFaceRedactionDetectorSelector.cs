...
//   ExistingNanoCloudFaceDetector -> reuse the AI substrate's face-box detector
...
public sealed class PlateFaceRedactionDetectorSelector : IPlateFaceRedactionDetector
{
    ...
    private readonly ExistingNanoCloudPlateFaceBoxDetector _existing;
    ...
    public PlateFaceRedactionDetectorSelector(
        ...
        ExistingNanoCloudPlateFaceBoxDetector existing,
    ...
    public bool IsAvailable => _options.ResolveProvider() switch
    {
        ...
        PlateFaceRedactionProvider.ExistingNanoCloudFaceDetector => _existing.IsAvailable,
    ...
    private IPlateFaceRedactionDetector Selected() => _options.ResolveProvider() switch
    {
        ...
        PlateFaceRedactionProvider.ExistingNanoCloudFaceDetector => _existing,
