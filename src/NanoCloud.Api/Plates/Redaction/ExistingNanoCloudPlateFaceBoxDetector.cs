...
// unredacted image.
public sealed class ExistingNanoCloudPlateFaceBoxDetector : IPlateFaceRedactionDetector
{
    ...
    private readonly ILogger<ExistingNanoCloudPlateFaceBoxDetector> _logger;

    public ExistingNanoCloudPlateFaceBoxDetector(
        IAiBackendResolver resolver,
        IAiProfileRegistry profiles,
        ILogger<ExistingNanoCloudPlateFaceBoxDetector> logger,
    ...
    // routes here when the provider is ExistingNanoCloudFaceDetector.
