...
using NanoCloud.Api.Plates.Alpr;
using NanoCloud.Api.Plates.Redaction;
...
// redaction = DeterministicDev | ExistingNanoCloudFaceDetector. Production
...
{
    public static IServiceCollection AddNanoCloudPlates(this IServiceCollection services)
    {
        ...
        //   ExistingNanoCloudFaceDetector -> reuse the AI face-box detector (boxes
        ...
        services.AddScoped<ExistingNanoCloudPlateFaceBoxDetector>();
