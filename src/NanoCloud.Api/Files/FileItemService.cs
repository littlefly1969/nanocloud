...
public sealed class FileItemService : IFileItemService
{
    ...
    private readonly NanoCloud.Api.MediaLibrary.IMediaLibraryService? _mediaLibrary;
    ...
    public FileItemService(
        ...
        NanoCloud.Api.MediaLibrary.IMediaLibraryService? mediaLibrary = null,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (_mediaLibrary is not null)
        {
            query = _mediaLibrary.ApplyMediaLibraryVisibility(
                query, NanoCloud.Api.MediaLibrary.MediaKind.Photo);
        }
        ...
        // leak here.
        query = NanoCloud.Api.MediaLibrary.MediaLibraryScopePolicy.ApplyScope(
            query, NanoCloud.Api.MediaLibrary.MediaLibraryScope.Active);
        ...
        if (_mediaLibrary is not null)
        {
            query = kind switch
            {
                ...
                MediaKindScope.Video => _mediaLibrary.ApplyMediaLibraryVisibility(
                    query, NanoCloud.Api.MediaLibrary.MediaKind.Video),
