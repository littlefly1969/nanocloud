...
public static class TvEndpoints
{
    ...
    public static IEndpointRouteBuilder MapTvEndpoints(this IEndpointRouteBuilder app)
    {
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            {
                NanoCloud.Api.Ai.NaturalGallery.InterpretOutcomeKind.Ok =>
        ...
        app.MapGet("/api/tv/personal/media/{fileId:guid}/video", async (
            ...
            [FromServices] ITvPersonalAreaService personal,
            [FromServices] IFileItemService files,
            [FromServices] NanoCloud.Api.Data.AppDbContext db,
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            var inactive = new NanoCloud.Api.Tv.TvFaceSearchActiveDto(
                false, null, null, null, null, Array.Empty<NanoCloud.Api.Tv.TvAlbumItemDto>());
            ...
            return items.Count == 0
                ? Results.Ok(inactive)
                : Results.Ok(new NanoCloud.Api.Tv.TvFaceSearchActiveDto(
                    true,
                    view.SearchId,
    ...
    private static async Task<(IResult? Failure, Guid OwnerUserId)> ResolveTvPersonalAccessAsync(
        HttpContext httpContext,
        NanoCloud.Api.Tv.ITvPersonalAreaService personal,
        CancellationToken cancellationToken)
    {
        var access = await personal.ResolveAccessAsync(
            httpContext.Request.Cookies[NanoCloud.Api.Tv.TvPairingService.CookieName],
            httpContext.Request.Headers[NanoCloud.Api.Tv.TvPersonalAreaService.UnlockHeader].ToString(),
            cancellationToken);
        return access.Status switch
        {
            NanoCloud.Api.Tv.TvPersonalAccessStatus.SessionInvalid
                => (Results.Unauthorized(), Guid.Empty),
            NanoCloud.Api.Tv.TvPersonalAccessStatus.GrantStalePinChanged
                => (Results.Json(new { error = "pin_changed" }, statusCode: StatusCodes.Status403Forbidden), Guid.Empty),
            NanoCloud.Api.Tv.TvPersonalAccessStatus.GrantInvalid
