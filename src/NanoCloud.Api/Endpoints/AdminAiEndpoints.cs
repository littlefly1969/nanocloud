...
public static class AdminAiEndpoints
{
    public static IEndpointRouteBuilder MapAdminAiEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        app.MapGet("/api/admin/ai/face-settings", async (
            [FromServices] NanoCloud.Api.Ai.Faces.FaceDiagnosticsService faces,
            CancellationToken cancellationToken) =>
        {
        ...
        app.MapPut("/api/admin/ai/face-settings", async (
            ...
            HttpContext httpContext,
            [FromServices] NanoCloud.Api.Ai.Faces.FaceSettingsService settings,
            [FromServices] NanoCloud.Api.Ai.Faces.FaceDiagnosticsService faces,
            [FromServices] IAuditLogger audit,
            CancellationToken cancellationToken) =>
        {
            ...
            var update = new NanoCloud.Api.Ai.Faces.FaceSettingsUpdate(
            ...
            catch (NanoCloud.Api.Ai.Faces.FaceSettingsValidationException ex)
            {
        ...
        // commands. See src/NanoCloud.Api/Admin/AdminJobCommands.cs.)
